...
public class CuentaBancariaM {
    ...
    public CuentaBancariaM(String titular) {
        this(titular, 0);
    }

    public CuentaBancariaM(String titular, double saldoInicial) {
    ...
    public static void main(String[] args) {
        CuentaBancariaM cuenta1 = new CuentaBancariaM("Juan Pérez", 1000);
        System.out.println("Cuenta creada: " + cuenta1.getNumeroCuenta());
        cuenta1.depositar(500);
        cuenta1.retirar(200);

        CuentaBancariaM cuenta2 = new CuentaBancariaM("María López");
