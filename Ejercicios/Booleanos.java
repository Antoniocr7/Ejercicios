public class Booleanos {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Ejemplo con variable local:");
        ejemplo.ejemploVariableLocal();

        // Ejemplo con array de booleanos
        boolean[] estados = new boolean[3];
        System.out.println("Valores iniciales del array de booleanos:");
        ...
        estados[1] = true;
        System.out.println("Después de cambiar el segundo elemento:");
        for (int i = 0; i < estados.length; i++) {
            System.out.println("Estado " + i + ": " + estados[i]);
        }
    }
